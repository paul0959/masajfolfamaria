...
import profileImg from '../assets/maria.jpg';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h3 className="text-2xl font-light text-cream-200 mb-6">
              "Atingerea potrivită poate vindeca nu doar corpul, ci și sufletul."
            </h3>
            ...
            <div className="space-y-6 text-cream-100/80 font-light leading-relaxed">
              ...
              <p>
                Cabinetul meu din Șanț este gândit ca un sanctuar de liniște. Aici, combin tehnici tradiționale de masaj terapeutic cu terapii complementare (ventuze, roci vulcanice, reflexoterapie) pentru a oferi rezultate reale, vizibile și durabile.
              </p>
            </div>
