      ...
      <div className="max-w-[1400px] w-full mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 items-center relative z-10 py-4 md:py-16">
        ...
        <div className="order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-6xl lg:text-[5rem] xl:text-[5.5rem] text-sage-900 font-serif leading-[1.1] tracking-tight mb-8"
          >
            Vindecare <br className="hidden lg:block"/>
            <span className="italic text-sage-700">prin</span> atingere.
          </motion.h1>
          ...
          <motion.p 
            ...
            className="text-lg md:text-xl text-sage-600 mb-12 max-w-lg font-light leading-relaxed"
          >
          ...
          >
            <button 
              ...
              className="group relative flex items-center justify-center gap-3 bg-sage-900 text-cream-50 px-10 py-5 w-full sm:w-auto overflow-hidden transition-all hover:shadow-lg"
            >
