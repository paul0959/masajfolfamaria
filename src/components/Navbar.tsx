...
export default function Navbar({ onOpenReviews, onOpenBooking }: { onOpenReviews?: () => void, onOpenBooking?: () => void }) {
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
        <a href="#acasa" className="flex items-center gap-4 group">
          ...
          <div className="flex flex-col">
            <span className={`text-lg md:text-xl font-serif tracking-[0.15em] uppercase transition-colors duration-500 ${isScrolled ? 'text-sage-900' : 'text-sage-900'}`}>
              Folfa Maria
            </span>
