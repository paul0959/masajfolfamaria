            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sage-600">Municipiul Bistrița, strada Zorilor Nr. 15<br/>Jud. Bistrița-Năsăud</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:folfamaria@yahoo.com" className="text-sage-600 hover:text-gold-500 transition-colors">folfamaria@yahoo.com</a>
                </div>
              </div>
...
<p className="text-sage-600">Luni - Vineri: 08:00 - 20:00<br/>Sâmbătă - Duminică: Închis</p>
          ...
          >
            {/* Embedded Google Maps - Actualizat pe Strada Zorilor 15, Bistrita */}
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2734.502804369062!2d24.5049534!3d47.1340156!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4749f63ab8edc4d3%3A0x5a18a58ed5287f3!2sStrada%20Zorilor%2015%2C%20Bistri%C8%9Ba!5e0!3m2!1sro!2sro!4v1715000000000!5m2!1sro!2sro" 
